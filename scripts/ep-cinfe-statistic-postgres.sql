...
(
    ...
    PR_PROFILE_STATUS NUMERIC(38, 0) NOT NULL,
    PR_NAME        VARCHAR(50)    NOT NULL,
    CONSTRAINT EP_PROFILE_PK PRIMARY KEY (PR_ID),
    CONSTRAINT EP_PROFILE_UN1 UNIQUE (PR_UUID),
    CONSTRAINT EP_PROFILE_FK1 FOREIGN KEY (PR_PROFILE_STATUS) REFERENCES EP_PROFILE_STATUS (PS_ID)
);
...
CREATE TABLE public.EP_BRIGADE_STATUS
(
    BS_ID          NUMERIC(38, 0) NOT NULL,
    BS_UUID        VARCHAR(36)    NOT NULL,
    BS_CODE        VARCHAR(11)    NOT NULL,
    BS_NAME        VARCHAR(11)    NOT NULL,
    BS_DESCRIPTION VARCHAR(20),
    CONSTRAINT EP_BRIGADE_STATUS_PK PRIMARY KEY (BS_ID),
    CONSTRAINT EP_BRIGADE_STATUS_UN1 UNIQUE (BS_UUID),
    CONSTRAINT EP_BRIGADE_STATUS_UN2 UNIQUE (BS_CODE),
    CONSTRAINT EP_BRIGADE_STATUS_UN3 UNIQUE (BS_NAME)
);
CREATE TABLE public.EP_UNIT_STATUS
(
    US_ID          NUMERIC(38, 0) NOT NULL,
    US_UUID        VARCHAR(36)    NOT NULL,
    US_CODE        VARCHAR(11)    NOT NULL,
    US_NAME        VARCHAR(11)    NOT NULL,
    US_DESCRIPTION VARCHAR(20),
    CONSTRAINT EP_UNIT_STATUS_PK PRIMARY KEY (US_ID),
    CONSTRAINT EP_UNIT_STATUS_UN1 UNIQUE (US_UUID),
    CONSTRAINT EP_UNIT_STATUS_UN2 UNIQUE (US_CODE),
    CONSTRAINT EP_UNIT_STATUS_UN3 UNIQUE (US_NAME)
);
...
(
    ...
    CONSTRAINT EP_DIVISION_FK1 FOREIGN KEY (DI_STATUS) REFERENCES EP_DIVISION_STATUS (DS_ID)
);
...
(
    ...
    BR_STATUS       NUMERIC(38, 0) NOT NULL,
    ...
    CONSTRAINT EP_BRIGADE_FK2 FOREIGN KEY (BR_STATUS) REFERENCES EP_BRIGADE_STATUS (BS_ID)
);
CREATE TABLE public.EP_UNIT
(
    UN_ID           NUMERIC(38, 0) NOT NULL,
    UN_UUID         VARCHAR(36)    NOT NULL,
    UN_BRIGADE_ID   NUMERIC(38, 0) NOT NULL,
    UN_STATUS       NUMERIC(38, 0) NOT NULL,
    ...
    CONSTRAINT EP_UNIT_FK1 FOREIGN KEY (UN_BRIGADE_ID) REFERENCES EP_BRIGADE (BR_ID),
    CONSTRAINT EP_UNIT_FK2 FOREIGN KEY (UN_STATUS) REFERENCES EP_UNIT_STATUS (US_ID)
);
...
CREATE SEQUENCE IF NOT EXISTS public.EP_DIVISION_STATUS_SEQ
    ...
    MAXVALUE 99999999999999999
    START 1;
CREATE SEQUENCE IF NOT EXISTS public.EP_BRIGADE_STATUS_SEQ
    INCREMENT BY 1
    MINVALUE 1
    MAXVALUE 99999999999999999
    START 1;
CREATE SEQUENCE IF NOT EXISTS public.EP_UNID_STATUS_SEQ
    INCREMENT BY 1
    MINVALUE 1
    MAXVALUE 99999999999999999
    START 1;
...
INSERT INTO EP_PROFILE(PR_ID, PR_UUID, PR_PROFILE_STATUS, PR_NAME)
...
SELECT *
FROM EP_DIVISION_STATUS
WHERE DS_ID = 1;
SELECT nextval('EP_DIVISION_STATUS_SEQ');